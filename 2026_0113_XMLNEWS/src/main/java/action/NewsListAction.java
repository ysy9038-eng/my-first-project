...
/**
 * Servlet implementation class newsListAction
 */
...
public class NewsListAction extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		// /news/list.do
		// /news/list.do?p_name=자바&start=1&display=10
		...
		List<NewsVo> list = MySearchUtil.search_news(n_name, start, display);
		
		
		request.setAttribute("list", list);
		
		// Dispatcher(forward)
		String forward_page = "news_list.jsp";
